...
def main(only_hpsv2_benchmark: bool = False):
    if only_hpsv2_benchmark:
        ...
        hpsv2.evaluate(
            "/data/ag/artifacts/neurips2025/hpsv2_images/1024_crop_ft_laion_pop_400k/hpsv2.1/",
            batch_size=40,
            hps_version="v2.1",
        )
    else:
        ...
        dataset = GenDataset(
            image_path="/data/ag/artifacts/neurips2025/partiprompts_images/1024_crop_imagenet_ft_400k/parti_long",
...
if __name__ == "__main__":
    main(only_hpsv2_benchmark=True)
